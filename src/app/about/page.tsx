...
const AboutPage = () => {
  return (
    <div className="w-full py-16 bg-gradient-to-b from-white to-neutral-100">
      {/* Header Section */}
      <motion.div
        className="w-full flex flex-col items-center justify-center gap-6 text-center mb-5"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
      >
        <h1 className="text-7xl mx-auto mt-5 font-bold text-stone-800">
          Prime<span className="text-primary">Vista</span>
        </h1>
        <p className="text-lg max-w-3xl text-gray-600">
          Where Innovation, Precision, and Partnership Define Success
        </p>
      </motion.div>
      ...
      <div className="mx-auto py-16 px-16 md:px-8 lg:px-28 grid grid-cols-1 lg:grid-cols-2 gap-12 justify-items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-xl leading-10">
            ...
            taxation, and data analytics solutions tailored to meet the evolving
      ...
      >
        ...
        <p className="text-neutral-100 mt-4 leading-relaxed text-lg">
          With PrimeVista Global by your side, you&apos;re not just outsourcing
          a task; you&apos;re building a partnership rooted in trust, expertise,
          and shared success. Whether you need help with day-to-day bookkeeping,
          comprehensive tax strategies, or advanced data insights, we&apos;re
          here to make it happen—efficiently, effectively, and effortlessly.
        </p>
      </motion.div>
      <WhyChooseUs />
      <OurApproches />
