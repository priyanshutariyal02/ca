...
const data = [
        ...
        <ul className="pl-6 text-neutral-600 text-lg mb-8">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              easier and ensuring full compliance.
            </span>
          </li>
        </ul>
        <p className="text-neutral-600 text-lg mb-8">
...

  {
    ...
    content: (
      <div>
        <p className="text-neutral-600 text-lg mb-8">
          Our Bank Reconciliation service ensures that your business&apos;s
          financial records align with your bank statements. We perform regular
          checks and reconcile discrepancies between your internal records and
          bank transactions to ensure complete accuracy and prevent fraud.
        </p>
        <p className="text-neutral-600 text-lg mb-8">
          <strong>Key Features:</strong>
        </p>
        <ul className="pl-6 text-neutral-600 text-lg mb-8">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              actual bank balance, preventing overdrafts and managing cash flow
              effectively.
            </span>
          </li>
          <li className="flex items-center gap-2">
        ...
        <ul className="pl-6 text-neutral-600 text-lg mb-8">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              ensuring that everything is managed properly and in accordance
        ...
        <ul className="pl-6 text-neutral-600 text-lg mb-8">
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              goals, ensuring that your financial health supports your long-term
              vision.
            </span>
          </li>
          <li className="flex items-center gap-2">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              informed decisions about spending, investment, and growth
              strategies.
            </span>
          </li>
          <li className="flex items-center gap-2">
        ...
        <ul className="pl-6 text-neutral-600 text-lg mb-8">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              and international tax laws, managing any cross-border tax
              implications.
            </span>
          </li>
          <li className="flex items-center gap-2">
